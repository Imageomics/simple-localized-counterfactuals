"""
Code directly imported from https://github.com/guillaumejs2403/ACE/blob/main/eval_utils/oracle_celebahq_metrics.py
which was directly imported from https://github.com/valeoai/STEEX/blob/b4141c287aa8fd66ab1096442da81084dd2f5504/models/OracleResnetModel.py
"""
...
# Adapted from: https://github.com/guillaumejs2403/ACE/blob/main/models/normalizer.py
...
class CelebAHQOracle:
    def __init__(self, weights_path):
        ...
        self.oracle = Normalizer(oracle, [0.5] * 3, [0.5] * 3).cuda()
        self.oracle.eval()
