...
# Adapted from: https://github.com/guillaumejs2403/ACE/blob/main/eval_utils/oracle_celeba_metrics.py
...
class OracleMetrics(nn.Module):
    def __init__(self, weights_path):
        ...
        self.oracle = Oracle(feat_extract, classifier)
        self.oracle.eval()
...
class CelebAOracle:
    def __init__(self, weights_path):
        self.oracle = OracleMetrics(weights_path=weights_path).cuda()
        self.oracle.eval()
